const api_root="https://3yxj274pzj.execute-api.us-east-1.amazonaws.com/register/"
function loadTable(){
...
function userCreate(){
    ...
    const xhttp = new XMLHttpRequest();
    const data= JSON.stringify({"fname": fname,"lname": lname,"username": username,"email": email,"avatar": "https://cdn2.iconfinder.com/data/icons/circle-avatars-1/128/050_girl_avatar_profile_woman_suit_student_officer-512.png"})
    console.log(data);
    xhttp.open("POST",api_root + "user");
    xhttp.setRequestHeader("Content-Type","application/json;charset=UTF-8");
    xhttp.send(JSON.stringify({"id":id , "fname": fname,"lname": lname,"username": username,"email": email,"avatar": "https://cdn2.iconfinder.com/data/icons/circle-avatars-1/128/050_girl_avatar_profile_woman_suit_student_officer-512.png"}));
